...
class Family:
    ...
    def __init__(self, last_name):
        ...
        self._members = [
            {"first_name": "John", "age": "33 Years old", "gender": "Male", "Lucky Numbers": [7, 13, 22], "member_id": randint(0, 99999999)},
            {"first_name": "Jane", "age": "35 Years old", "gender": "Female", "Lucky Numbers": [10, 14, 3], "member_id": randint(0, 99999999)},
            {"first_name": "Jimmy", "age": "5 Years old", "gender": "Male", "Lucky Numbers": [1], "member_id": randint(0, 99999999)}]
